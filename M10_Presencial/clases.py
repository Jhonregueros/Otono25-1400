...
def saludar(nombre):
    saludo = f"Hola, {nombre}! Qué gusto verte!"
    return saludo

# 2. Función para calcular el área de un rectangulo
...
class Gato:
    ...
    def dormir(self, horas):
        return f"{self.nombre} está durmiendo {horas} horas."

    def jugar(self, juguete):
        return f"{self.nombre} está jugando con {juguete}."
...
# 5.1. Definir la clase Time y asignar atributos
...
# 5.2. Crear una función para sumar horas, minutos y segundos
...
# 5.3. Modificar la clase Time para hacerla más robasta
